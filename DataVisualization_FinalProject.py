...
#Plot 2 Calculate the average number of vehicles sold by vehicle type
        ...
        R_chart2  = dcc.Graph(figure=px.bar(average_sales,
                                            x='Vehicle_Type',
                                            y='Automobile_Sales',
                                            title='Average Automobile Sales by Vehicle Type during a Recession'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        month=yearly_data.groupby('Month')['Automobile_Sales'].sum().reset_index()
        Y_chart2 = dcc.Graph(figure=px.line(month,
                                            x='Month',
                                            y='Automobile_Sales',
